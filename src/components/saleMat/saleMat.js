...
import AddSaleMat from "./addSaleMat";

import ProductsForSale from "./ProductsForSaleMat";
...
const SaleMat = (props) => {
	...
	return (
		<div>
			<PageTitle title='Retour' subtitle={"SORTIE MATIÈRE PREMIÈRE"} />
